...
} else if (isset($_GET['ratingbarber'])) {
    $ratingbarber = $_GET['ratingbarber'];
    $sql = "select * from t_barbershop where rating_barber = $ratingbarber order by id_barbershop";
} else if (isset($_GET['hargabarber'])) {
    $hargabarber = $_GET['statvalidasi'];
    $sql = "select * from t_barbershop where harga_layanan = $hargabarber order by id_barbershop";
